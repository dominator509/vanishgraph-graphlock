# External sign-off request: EXT-GATE-04 - hardware, HSM or accredited assessment where applicable
...
- role: Accredited assessor
- owner contact: ADR-006 (no managed KMS exists) and .agent/verification/CAPABILITY_MATRIX.md
