# External sign-off request: EXT-GATE-05 - production deployment authorization
...
- role: Authorised operator (manual only)
- owner contact: deploy/production/README.md; VG-SCOPE-009
