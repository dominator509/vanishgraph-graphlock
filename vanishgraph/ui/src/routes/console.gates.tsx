/**
 * /console/gates — Operations console (SPEC-004 §1, VG-UI-004).
 *
 * PURPOSE: `HUMAN_REQUIRED` triage
...
export function Page_console_gates(): React.JSX.Element {
  return (
    <SubjectScopedGap
      path="/console/gates"
      surface="Operations console"
      purpose="`HUMAN_REQUIRED` triage"
      region="Human gates waiting for a decision"
      operation="loading the human gates"
    />
  );
}
