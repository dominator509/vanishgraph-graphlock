#!/usr/bin/env sh
# definition of done gate -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/dod-gate.sh
# Governing sentinel: definition of done: ok
#
...
vg_loud_fail 'definition of done gate' 'EP-010'
