#!/usr/bin/env sh
# harness run stage -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/harness-run-stage.sh
#
...
vg_loud_fail 'harness run stage' 'EP-010'
