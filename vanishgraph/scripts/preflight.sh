#!/usr/bin/env sh
# preflight -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/preflight.sh
# Governing sentinel: preflight: ok
#
