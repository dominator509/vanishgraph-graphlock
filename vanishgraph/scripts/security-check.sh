#!/usr/bin/env sh
# security check -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/security-check.sh
#
...
vg_loud_fail 'security check' 'EP-006'
