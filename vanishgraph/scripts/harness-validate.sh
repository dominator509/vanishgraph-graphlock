#!/usr/bin/env sh
# harness validation -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/harness-validate.sh
# Governing sentinel: harness validation: ok
#
...
vg_loud_fail 'harness validation' 'EP-010'
