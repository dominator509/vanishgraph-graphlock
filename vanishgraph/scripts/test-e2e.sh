#!/usr/bin/env sh
# end-to-end tests -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/test-e2e.sh
#
...
vg_loud_fail 'end-to-end tests' 'EP-005'
