#!/usr/bin/env sh
# dependency audit -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/dependency-audit.sh
#
...
vg_loud_fail 'dependency audit' 'EP-001'
