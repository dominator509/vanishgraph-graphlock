#!/usr/bin/env sh
# format check -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/format-check.sh
#
...
vg_loud_fail 'format check' 'EP-001'
