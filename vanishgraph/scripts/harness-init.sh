#!/usr/bin/env sh
# harness init -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/harness-init.sh
#
...
vg_loud_fail 'harness init' 'EP-010'
