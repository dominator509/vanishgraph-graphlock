#!/usr/bin/env sh
# harness next -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/harness-next.sh
#
...
vg_loud_fail 'harness next' 'EP-010'
