#!/usr/bin/env sh
# TEMPORAL_ADDRESS readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that TEMPORAL_ADDRESS is present, then fails loudly. It does
# NOT assert reachability -- that is the EP-000 M1 discovery implementation.
set -eu
. "$(dirname "$0")/../lib/loud-fail.sh"
vg_require_env 'TEMPORAL_ADDRESS' 'EP-002'
vg_loud_fail 'TEMPORAL_ADDRESS probe' 'EP-002'
