#!/usr/bin/env sh
# S3_ENDPOINT readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that S3_ENDPOINT is present, then fails loudly. It does
...
vg_loud_fail 'S3_ENDPOINT probe' 'EP-003'
