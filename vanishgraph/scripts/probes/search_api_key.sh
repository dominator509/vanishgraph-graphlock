#!/usr/bin/env sh
# SEARCH_API_KEY readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that SEARCH_API_KEY is present, then fails loudly. It does
...
vg_loud_fail 'SEARCH_API_KEY probe' 'EP-013'
