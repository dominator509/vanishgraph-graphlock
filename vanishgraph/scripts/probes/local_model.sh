#!/usr/bin/env sh
# LOCAL_MODEL_ENDPOINT readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that LOCAL_MODEL_ENDPOINT is present, then fails loudly. It does
...
vg_loud_fail 'LOCAL_MODEL_ENDPOINT probe' 'EP-013'
