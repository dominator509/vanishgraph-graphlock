#!/usr/bin/env sh
# KEYCLOAK_ISSUER readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that KEYCLOAK_ISSUER is present, then fails loudly. It does
...
vg_loud_fail 'KEYCLOAK_ISSUER probe' 'EP-006'
