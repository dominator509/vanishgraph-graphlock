#!/usr/bin/env sh
# DATABASE_URL readiness probe -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
...
#
# This guard checks only that DATABASE_URL is present, then fails loudly. It does
...
vg_loud_fail 'DATABASE_URL probe' 'EP-003'
