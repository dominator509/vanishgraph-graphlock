#!/usr/bin/env sh
# live-fire proof -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/live-fire.sh
#
...
vg_loud_fail 'live-fire proof' 'EP-010'
