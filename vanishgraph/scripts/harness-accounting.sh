#!/usr/bin/env sh
# harness accounting -- PRE-DISCOVERY LOUD-FAIL PLACEHOLDER.
#
# Implemented command (declared in COMMANDS.md): sh scripts/harness-accounting.sh
#
...
vg_loud_fail 'harness accounting' 'EP-010'
